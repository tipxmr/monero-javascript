...
class MoneroTx {
  ...
  constructor(state) {
    ...
    if (state.unlockTime !== undefined && !(state.unlockTime instanceof BigInt)) state.unlockTime = BigInt(state.unlockTime);
  ...
  setUnlockTime(unlockTime) {
    if (unlockTime !== undefined) {
      ...
      if (!(unlockTime instanceof BigInt)) {
        try { unlockTime = BigInt(unlockTime); }
