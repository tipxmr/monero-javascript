...
import MoneroFeeEstimate from "./src/main/js/daemon/model/MoneroFeeEstimate";
...
export {MoneroPeer};
import MoneroPruneResult from "./src/main/js/daemon/model/MoneroPruneResult";
 ...
 * @return {Promis<MoneroWalletKeys>} the created wallet
 */
